...
@section('problem-sub-content')
    ...
    <div id="problem-details-editor-body" style="display: none;">
        <div class="details-section">
            <div class="row">
                <div class="col-md-3">
                    <div class="option-name">Problem Name</div>
                </div>
                <div class="col-md-9"><input type="text" id="problem_name" class="form-control" style="width: 520px;"
                        name="" value="{{ $problem->name }}"></div>
            </div>
        </div>
        <div class="details-section">
            <div class="row">
                <div class="col-md-3">
                    <div class="option-name">Problem Statement</div>
                </div>
        ...
        <div class="details-section">
            <div class="row">
                <div class="col-md-3">
                    <div class="option-name">Input Statement</div>
                </div>
        ...
        <div class="details-section">
            <div class="row">
                <div class="col-md-3">
                    <div class="option-name">Output Statement</div>
                </div>
        ...
        <div class="details-section">
            <div class="row">
                <div class="col-md-3">
                    <div class="option-name">Constraints</div>
                </div>
        ...
        <div class="details-section">
            <div class="row">
                <div class="col-md-3">
                    <div class="option-name">Note</div>
                </div>
        ...
        <div class="footer navbar-fixed-bottom footer-save">
            <button class="btn btn-primary"
                onclick="new Modal('custom',700).load('{{ route('administration.filemanager.structure') }}','File Manager')">Upload
                Image</button>
            <button id="update-problem-preview" type="submit" class="btn btn-primary"
                url="{{ route('administration.problem.preview_problem', ['slug' => request()->slug]) }}"
                onclick="problem.preview(this)">Preview</button>
            <button id="update-problem-details" type="submit" class="btn btn-primary"
                onclick="problem.detailsUpadte('{{ route('administration.problem.statement', ['slug' => request()->slug]) }}')">Update
                Details</button>
        </div>
    </div>
