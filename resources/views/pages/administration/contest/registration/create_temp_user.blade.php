<form class="form" action="{{route('administration.contest.registrations.create_temp_user',['contest_id' => request()->contest_id])}}" method="post" id="generateTempUser"  enctype="multipart/form-data">
	...
	<div class="col-md-12" style="margin-top: -5px">
     ...
     <div class='row' style="margin-bottom: 5px;">
        ...
        <div class="col-md-8">
                <input type="text" class='form-control-input' name="handle_prefix" placeholder="Enter Handle Prefix">
    ...
    <div class='row' style="margin-bottom: 5px;">
        ...
        <div class="col-md-8">
                <input type="number" class='form-control-input' name="password_length" placeholder="Password Length">
    ...
    <div class='row' style="margin-bottom: 5px;">
        ...
        <div class="col-md-8">
        	<input type="file" name="data_file" accept=".csv" class='form-control-input'>
