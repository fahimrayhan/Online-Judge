...
<div class="pull-right" style="margin-bottom: 20px;">
    <button class="btn btn-primary" onclick="new Modal('md').load('{{route('administration.contest.registrations.create_temp_user',['contest_id' => request()->contest_id])}}')">Create Temp User</button>
