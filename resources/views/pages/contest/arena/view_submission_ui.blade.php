           	...
           	<div class="body subBody" style="overflow-x: scroll;scrollbar-width: none;">
                ...
                <table width="100%" id="submission_table" class="table-custom submission-table">
                	...
                	<tr class="submissionTr">
                		...
                		<td><a callback="(new Modal()).close()" href="{{route('contest.arena.problems.view',['contest_slug' => request()->contest_slug,'problem_no' => $problemKey])}}">{{$problemKey}}. {{$submission->problem->name}}</a></td>
