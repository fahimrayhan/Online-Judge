...
! function(t, e) {
    ...
    var Z, tt = {
        ...
        Ot = function(t, e) {
            var i = Tt[Ct(t)];
            return i == It || i != Pt && ("function" == typeof e ? r(e) : !!e)
        },
        ...
        Bt = a ? Object.defineProperties : function(t, e) {
            P(t);
            for (var i, n = _t(e), o = n.length, r = 0; o > r;) A.f(t, i = n[r++], e[i]);
            return t
        },
    ...
    var Ut = Object.create || function(t, e) {
            var i;
            return null !== t ? (Lt.prototype = P(t), i = new Lt, Lt.prototype = null, i[Dt] = t) : i = Mt(), void 0 === e ? i : Bt(i, e)
        },
        zt = yt.f,
        qt = {}.toString,
        ...
        Re = function(t, e, i) {
            ...
            return P(i), w(xe, n) ? (i.enumerable ? (w(t, ue) && t[ue][n] && (t[ue][n] = !1), i = Ut(i, {
                enumerable: h(0, !1)
            })) : (w(t, ue) || ye(t, ue, h(1, {})), t[ue][n] = !0), Ae(t, n, i)) : ye(t, n, i)
        },
        je = function(t, e) {
            P(t);
            var i = v(e),
    ...
    if (Rt || (et((ve = function() {
            ...
            var t = arguments.length && void 0 !== arguments[0] ? String(arguments[0]) : void 0,
                e = U(t),
                i = function(t) {
                    this === ge && i.call(ke, t), w(this, ue) && w(this[ue], e) && (this[ue][e] = !1), Ae(this, e, h(1, t))
                };
            return a && Ie && Ae(ge, e, {
                configurable: !0,
                set: i
            ...
            return fe(this).tag
        })), c.f = Ne, A.f = Re, T.f = Fe, yt.f = Gt.f = _e, wt.f = Be, a && (ye(ve.prototype, "description", {
            configurable: !0,
            get: function() {
    ...
    var ki, Oi, Ci, Ti = !r((function() {
        ...
        Pi = q("IE_PROTO"),
        Ii = Object.prototype,
        Ai = Ti ? Object.getPrototypeOf : function(t) {
            return t = Ft(t), w(t, Pi) ? t[Pi] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? Ii : null
        },
        $i = Xt("iterator"),
        Ei = !1;
    [].keys && ("next" in (Ci = [].keys()) ? (Oi = Ai(Ai(Ci))) !== Object.prototype && (ki = Oi) : Ei = !0), null == ki && (ki = {}), w(ki, $i) || $(ki, $i, (function() {
        return this
    }));
    var Ri = {
        ...
        Di = function(t, e, i, n, o, r, a) {
            ...
            if (b && (s = Ai(b.call(new t)), Fi !== Object.prototype && s.next && (Ai(s) !== Fi && (Ni ? Ni(s, Fi) : "function" != typeof s[Bi] && $(s, Bi, Vi)), ne(s, d, !0))), "values" == o && g && "values" !== g.name && (p = !0, v = function() {
                    return g.call(this)
                }), f[Bi] !== v && $(f, Bi, v), o)
                if (l = {
                        values: u("values"),
        ...
        Mi = Di(Array, "Array", (function(t, e) {
            Li(this, {
                type: "Array Iterator",
                target: v(t),
                index: 0,
    ...
    var $n = c.f,
        En = function(t) {
            return function(e) {
                for (var i, n = v(e), o = _t(n), r = o.length, s = 0, l = []; r > s;) i = o[s++], a && !$n.call(n, i) || l.push(t ? [i, n[i]] : n[i]);
                return l
            }
        },
        Rn = {
        ...
        ko = function(t, e, i, n) {
            var o = Xt(t),
                ...
                s = a && !r((function() {
                    var e = !1,
                        i = /a/;
                    return "split" === t && ((i = {}).constructor = {}, i.constructor[yo] = function() {
                        return i
    ...
    ko("replace", 2, (function(t, e, i, n) {
        return [function(i, n) {
            ...
            for (var d = [];;) {
                ...
                if (null === p) break;
                if (d.push(p), !h) break;
                "" === String(p[0]) && (s.lastIndex = Co(l, ct(s.lastIndex), u))
            }
        ...
        return n = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, i) {
            ...
            var a = P(t),
                ...
                l = function(t, e) {
                    ...
                    return void 0 === n || null == (i = P(n)[jo]) ? e : oe(i)
                }(a, RegExp),
                c = a.unicode,
    ...
    var mr = T.f,
        ...
        Sr = po("startsWith"),
        xr = !Sr && !! function() {
            var t = mr(String.prototype, "startsWith");
            return t && !t.writable
        }();
    Et({
        target: "String",
    ...
    var kr = {
        ...
        Cr = function() {
            function e(i, n) {
                Qo(this, e), this.options = n, this.$el = t(i), this.$el_ = this.$el.clone(), this.timeoutId_ = 0, this.timeoutFooter_ = 0, this.init()
            }
            return tr(e, [{
                key: "init",
                value: function() {
                ...
                value: function() {
                    ...
                    this.header = {
                        ...
                        cellStyles: [],
                        searchables: []
                    }, kr.updateFieldGroup(this.options.columns), this.options.columns.forEach((function(t, o) {
                ...
                key: "initData",
                value: function(t, e) {
                    "append" === e ? this.options.data = this.options.data.concat(t) : "prepend" === e ? this.options.data = [].concat(t).concat(this.options.data) : (t = t || this.options.data, this.options.data = Array.isArray(t) ? t : t[this.options.dataField]), this.data = ir(this.options.data), this.options.sortReset && (this.unsortedData = ir(this.data)), "server" !== this.options.sidePagination && this.initSort()
                }
            }, {
                key: "initSort",
                value: function() {
                    ...
                    })), this.options.customSort ? kr.calculateObjectValue(this.options, this.options.customSort, [this.options.sortName, this.options.sortOrder, this.data]) : this.data.sort((function(o, r) {
                    ...
                    if (o.push("</div>"), (this.showToolbar || o.length > 2) && this.$toolbar.append(o.join("")), n.showPaginationSwitch && this.$toolbar.find('button[name="paginationSwitch"]').off("click").on("click", (function() {
                        ...
                        if (a <= n.minimumCountColumns && e.find("input").prop("disabled", !0), e.find("li, label").off("click").on("click", (function(t) {
                                ...
                                var n = e.currentTarget,
                                    o = t(n);
                                i._toggleColumn(o.val(), o.prop("checked"), !1), i.trigger("column-switch", o.data("field"), o.prop("checked")), g.prop("checked", f.filter(":checked").length === i.columns.filter((function(t) {
                                    return !i.isSelectionColumn(t)
                                })).length)
                        ...
                        if ((this.paginationParts.includes("pageInfo") || this.paginationParts.includes("pageInfoShort") || this.paginationParts.includes("pageSize")) && c.push("</span></div>"), this.paginationParts.includes("pageList")) {
                            ...
                            var g = Math.round(e.paginationPagesBySide / 2),
                                v = function(i) {
                                    ...
                                    return kr.sprintf(t.constants.html.paginationItem, n + (i === e.pageNumber ? " ".concat(t.constants.classes.paginationActive) : ""), e.formatSRPaginationPageText(i), i)
                                };
                            if (n > 1) {
                            ...
                            if (this.totalPages > o) {
                                ...
                                for (o >= m && (m = o + 1), o + 1 === m - 1 ? (i = o + 1, c.push(v(i))) : m > o + 1 && (this.totalPages - o > 2 * e.paginationPagesBySide && e.paginationUseIntermediate ? (i = Math.round((this.totalPages - g - o) / 2 + o), c.push(v(i, " page-intermediate"))) : c.push(kr.sprintf(this.constants.html.paginationItem, " page-last-separator disabled", "", "..."))), i = m; i <= this.totalPages; i++) c.push(v(i))
                            }
                ...
                value: function(e) {
                    ...
                    a ? this.options.virtualScroll ? (this.virtualScroll && this.virtualScroll.destroy(), this.virtualScroll = new Or({
                        rows: o,
                        fixedScroll: e,
                ...
                value: function() {
                    ...
                    })), this.$selectItem = this.$body.find(kr.sprintf('[name="%s"]', this.options.selectItemName)), this.$selectItem.off("click").on("click", (function(i) {
                ...
                value: function() {
                    ...
                    if (this.$el.is(":hidden")) this.timeoutId_ = setTimeout((function() {
                        ...
                        l.length > 0 && (l.focus(), this.$header.find(".focus-temp").removeClass("focus-temp")), this.$header.find("th[data-field]").each((function(i, n) {
                            e.$header_.find(kr.sprintf('th[data-field="%s"]', t(n).data("field"))).data(t(n).data())
                        }));
                ...
                key: "refreshOptions",
                value: function(e) {
                    kr.compareObjects(this.options, e, !0) || (this.options = t.extend(this.options, e), this.trigger("refresh-options", this.options), this.destroy(), this.init())
                }
            }, {
                key: "getData",
                value: function(t) {
                ...
                key: "filterBy",
                value: function(e, i) {
                    this.filterOptions = kr.isEmptyObject(i) ? this.options.filterOptions : t.extend(this.options.filterOptions, i), this.filterColumns = kr.isEmptyObject(e) ? {} : e, this.options.pageNumber = 1, this.initSearch(), this.updatePagination()
                }
            }, {
                key: "scrollTo",
                value: function(e) {
                    ...
                    "object" === Xo(e) ? i = Object.assign(i, e) : "string" == typeof e && "bottom" === e ? i.value = this.$tableBody[0].scrollHeight : "string" != typeof e && "number" != typeof e || (i.value = e);
                    var n = i.value;
                ...
                value: function(t, e) {
                    this.$body.find(kr.sprintf('> tr[data-index="%s"]', t)).next().is("tr.detail-view") ? this.collapseRow(t) : this.expandRow(t, e), this.resetView()
                }
            }, {
                key: "expandRow",
                value: function(t, e) {
                ...
                value: function(e) {
                    e.hasOwnProperty("field") && e.hasOwnProperty("title") && (this.columns[this.fieldsColumnsIndex[e.field]].title = this.options.escape ? kr.escapeHTML(e.title) : e.title, this.columns[this.fieldsColumnsIndex[e.field]].visible && (void 0 !== this.options.height ? this.$tableHeader : this.$header).find("th[data-field]").each((function(i, n) {
    ...
    }, t.fn.bootstrapTable.Constructor = Cr, t.fn.bootstrapTable.theme = hr.THEME, t.fn.bootstrapTable.VERSION = hr.VERSION, t.fn.bootstrapTable.defaults = Cr.DEFAULTS, t.fn.bootstrapTable.columnDefaults = Cr.COLUMN_DEFAULTS, t.fn.bootstrapTable.events = Cr.EVENTS, t.fn.bootstrapTable.locales = Cr.LOCALES, t.fn.bootstrapTable.methods = Cr.METHODS, t.fn.bootstrapTable.utils = kr, t((function() {
