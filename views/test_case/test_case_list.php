...
<div style='text-align: right; margin-bottom: 10px;'><button id="loadAddTestCaseBtn"><span class='glyphicon glyphicon-plus'></span> Add Test Case</button></div>
...
<table width='100%'>
	...
	<?php
		...
		<tr>
			...
			<td class='td2'> 
				<button value='<?php echo "$hashId"; ?>' class='btn-sm' onclick ='problemTestCase.loadUpdateTestCasePage(this)' id='updateTestCaseBtn'><span class='glyphicon glyphicon-pencil'></span></button>
				<button onclick='problemTestCase.deleteTestCase(this)' value='<?php echo "$hashId"; ?>' class='btn-sm'><span class='glyphicon glyphicon-trash'></span></button>
			</td>
			</tr>
		<?php } ?>
</table>
