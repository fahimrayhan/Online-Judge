...
.has-success .form-control:focus{
    border-color:#79a736;
    -webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 6px #c1de98;
...
.has-warning .form-control:focus{
    border-color:#ef5c0e;
    -webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075),0 0 6px #f9bd9d;
...
.navbar-form input,.navbar-form .form-control,.btn{
    border:none
}
.btn{
    font-size:11px;
...
.nav .open>a,.nav .open>a:hover,.nav .open>a:focus,.nav-tabs>li>a{
    border-color:#dfd7ca
}
.nav-tabs>li>a{
    color:#98978b
...
@font-face{
    ...
    src:url("../fonts/ubuntumono-regular-webfont.eot?#iefix") format('embedded-opentype'),url("../fonts/ubuntumono-regular-webfont.woff") format('woff'),url("../fonts/ubuntumono-regular-webfont.ttf") format('truetype'),url("../fonts/ubuntumono-regular-webfont.svg#ubuntu_monoregular") format('svg');
    font-weight:400;
    font-style:normal
}
.panel{
...
.panel>.panel-body,.panel>.panel-footer,.panel>.list-group .list-group-item,.panel .panel-heading+.list-group .list-group-item:first-child,.panel>.list-group:last-child .list-group-item:last-child,.panel>.table,.panel>.table-responsive{
    border:1px solid #eee;
    margin:2px 0
}
.panel>.table thead tr th,.panel>.table-responsive>.table thead tr th{
...
.mark-warning{
    border-right-color:#e99002
}
.automore .btn-automore-remove{
    display:none
}
#wrap{
    min-height:100%;
...
.table-submissions thead tr th:nth-child(1),.table-submissions tbody tr td:nth-child(1){
    width:72px;
    text-align:center
}
.table-submissions .ellipsis{
    width:100%;
    white-space:nowrap;
    overflow:hidden;
    text-overflow:ellipsis
}
.table-submissions tbody tr td:nth-child(2){
    max-width:194px
}
.table-submissions tbody tr td:nth-child(3){
    max-width:96px
}
.table-sample{
    thead:tr th
...
.panel-tests table tbody tr th:nth-child(1),.panel-tests table tbody tr td:nth-child(1){
    width:32px
}
.panel-tests table tbody tr th:nth-child(2),.panel-tests table tbody tr td:nth-child(2),.panel-tests table tbody tr th:nth-child(3),.panel-tests table tbody tr td:nth-child(3){
    width:160px
}
.panel .panel-body legend h1{
    margin-top:0
}
.panel-problems .panel-body.placeholder{
    height:96px
}
.panel-source .panel-body,.panel-compare .panel-body{
    font-family:'Ubuntu Mono';
    font-size:14px;
    vertical-align:top;
    white-space:pre;
...
#alerts .alert:nth-child(2){
    opacity:.75
}
#alerts .alert:nth-child(3){
    opacity:.5
}
#alerts .alert:nth-child(4){
    opacity:.25
}
#alerts .alert:nth-child(5){
    opacity:0
}
#alerts .alert:nth-child(n+6){
    display:none
}
.blog-post h4{
    margin-top:16px
...
.panel-problem .desc p:first-child img{
    float:right;
    margin:0 0 8px 24px
}
.print-selectable .badge{
    display:none
}
.print-selectable.print-selected .badge{
    display:inline-block
}
footer img{
    -webkit-transition:opacity .5s,-webkit-filter .5s,filter .5s;
    opacity:.375;
