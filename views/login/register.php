 ...
 <div class="row">
 	...
 	<div class="col-md-6">
 		<div class="box sm_border">
 			<div class="box_header"><i class='fas'>&#xf234;</i> Register into CoderOJ</div>
 			<div class="box_body">
                ...
                <div id="register_success" class="alert alert-success" style="display: none"></div>  
               	...
               	<input type="text" class="inputTxt" placeholder="Enter Your Handle" autocomplete="off" id="userFullName">

                <label for="username">Handle <b style="color: #EA2027">*</b></label>
                <input type="text" class="inputTxt"  placeholder="Enter Your Handle" autocomplete="off" id="userHandle">
                <div class="register_notice">
                  ...
                  <li>Handle Length Must Be <b>(4 to 14)</b></li>
               	...
               	<input type="text" class="inputTxt" placeholder="Enter Your Email" autocomplete="off" id="userEmail">
                
                <label for="username">Your Institute Name</label>
               	<input type="text" class="inputTxt" placeholder="Enter Your Institute Name" autocomplete="off" id="instituteName">
                                
                <label for="password">Password <b style="color: #EA2027">*</b></label><br>
                <input type="password" class="inputTxt" name="password" placeholder="Enter Your Password" id="userPassword">
                <div class="register_notice">
                  <li>Password Length Must Be Minimum 6</b></li>
                </div>
                <label for="password">Confirm Password <b style="color: #EA2027">*</b></label><br>
                <input type="password" class="inputTxt" name="password" placeholder="Confirm Password" id="userCpassword">
