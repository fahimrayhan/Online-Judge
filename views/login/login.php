 ...
 <div class="row">
 	...
 	<div class="col-md-4">
 		<div class="box sm_border">
 			<div class="box_header"><span class="glyphicon glyphicon-log-in"></span> Login into CoderOJ</div>
 			<div class="box_body">
 				...
 				<div id="login_success" class="alert alert-success" style="display: none"></div>         <label for="username">Handle</label>
               	<input type="text" class="inputTxt" placeholder="Enter Your Handle" autocomplete="off" id="handle">
                <label for="password">Password</label><br>
                <input type="password" class="inputTxt" placeholder="Enter Your Password" id="password">
