  ...
  <div class="container-fluid"> 
    <div class="navbar-header">
      ...
      <b class="navbar-brand nav_logo"><strong style="color: #ffffff;">Coder Online Judge</strong></b>
    </div>
    ...
    <div class="nevbar_fontstyle">
      <ul class="nav navbar-nav navbar-left" >
        ...
        <li class="li_nav"><a class="navbar_btn" style="color: #ced6e0;" href="judge_status.php"><i class="fas fa-random span_icon"></i>JUDGE STATUS</a></li>
